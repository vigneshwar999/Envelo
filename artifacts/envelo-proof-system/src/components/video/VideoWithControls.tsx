...
const SCENE_DETAILS: Record<string, { title: string; filePath: string }> = {
  scene1: { title: 'Public vs Sealed', filePath: 'src/components/video/video_scenes/Scene1.tsx' },
  scene2: { title: 'Seal', filePath: 'src/components/video/video_scenes/Scene2.tsx' },
  scene3: { title: 'Anchor', filePath: 'src/components/video/video_scenes/Scene3.tsx' },
  scene4: { title: 'Settle', filePath: 'src/components/video/video_scenes/Scene4.tsx' },
  scene5: { title: 'Verify', filePath: 'src/components/video/video_scenes/Scene5.tsx' },
};
