      ...
      <div className="relative h-full px-[4vw] pt-[13vh] pb-[11vh] flex flex-col">
        ...
        <div className="grid grid-cols-3 gap-[2.5vw] w-full">
          <div>
            ...
            <h3 className="mt-[2.6vh] text-[2.2vw] font-semibold tracking-tight text-primary">The envelope</h3>
            <p className="mt-[1.4vh] text-[2vw] leading-normal text-text/85 text-pretty">
              The invoice is encrypted before it leaves the sender's browser. The server holds a sealed envelope it cannot open.
            </p>
          </div>

          <div>
            <svg className="w-[3vw] h-[3vw] text-primary" viewBox="0 0 24 24" fill="none" aria-hidden="true">
              <circle cx="12" cy="12" r="9.5" stroke="currentColor" strokeWidth="1.4" />
              <circle cx="12" cy="12" r="5.5" stroke="currentColor" strokeWidth="1.2" strokeDasharray="2.2 2.4" />
              <circle cx="12" cy="12" r="1.4" fill="currentColor" />
            </svg>
            <h3 className="mt-[2.6vh] text-[2.2vw] font-semibold tracking-tight text-primary">The wax stamp</h3>
            <p className="mt-[1.4vh] text-[2vw] leading-normal text-text/85 text-pretty">
          ...
          <div>
            ...
            <h3 className="mt-[2.6vh] text-[2.2vw] font-semibold tracking-tight text-primary">The payment</h3>
            <p className="mt-[1.4vh] text-[2vw] leading-normal text-text/85 text-pretty">
