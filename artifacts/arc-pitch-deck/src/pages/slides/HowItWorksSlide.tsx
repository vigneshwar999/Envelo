    ...
    <div className="w-screen h-screen overflow-hidden relative bg-bg text-text font-body">
      ...
      <div className="relative h-full px-[4vw] pt-[13vh] pb-[11vh] flex flex-col">
        ...
        <div className="mt-[6vh] flex items-stretch gap-[1vw]">
          <div className="flex-1 rounded-[1.3vw] border border-white/10 bg-gradient-to-b from-white/[0.05] to-white/[0.015] p-[1.6vw]">
            <span className="font-mono text-[1.5vw] text-primary">01</span>
            <h3 className="mt-[1.2vh] text-[2.1vw] font-medium tracking-tight text-text">Seal</h3>
            <p className="mt-[1.2vh] text-[2vw] leading-normal text-muted text-pretty">
          ...
          <div className="flex-1 rounded-[1.3vw] border border-white/10 bg-gradient-to-b from-white/[0.05] to-white/[0.015] p-[1.6vw]">
            ...
            <h3 className="mt-[1.2vh] text-[2.1vw] font-medium tracking-tight text-text">Anchor</h3>
            <p className="mt-[1.2vh] text-[2vw] leading-normal text-muted text-pretty">
          ...
          <div className="flex-1 rounded-[1.3vw] border border-white/10 bg-gradient-to-b from-white/[0.05] to-white/[0.015] p-[1.6vw]">
            ...
            <h3 className="mt-[1.2vh] text-[2.1vw] font-medium tracking-tight text-text">Pay</h3>
            <p className="mt-[1.2vh] text-[2vw] leading-normal text-muted text-pretty">
          ...
          <div className="flex-1 rounded-[1.3vw] border border-white/10 bg-gradient-to-b from-white/[0.05] to-white/[0.015] p-[1.6vw]">
            ...
            <h3 className="mt-[1.2vh] text-[2.1vw] font-medium tracking-tight text-text">Grant</h3>
            <p className="mt-[1.2vh] text-[2vw] leading-normal text-muted text-pretty">
