...
const SCENE_DETAILS: Record<string, { title: string; filePath: string }> = {
  scene1: { title: 'What Invoices Reveal', filePath: 'src/components/video/video_scenes/Scene1.tsx' },
  scene2: { title: 'What Privacy Protects', filePath: 'src/components/video/video_scenes/Scene2.tsx' },
  scene3: { title: 'Sealed in Browser', filePath: 'src/components/video/video_scenes/Scene3.tsx' },
  scene4: { title: 'Proof on Arc', filePath: 'src/components/video/video_scenes/Scene4.tsx' },
  scene5: { title: 'Private Paperwork', filePath: 'src/components/video/video_scenes/Scene5.tsx' },
};
