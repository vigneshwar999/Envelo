...
const SCENE_DETAILS: Record<string, { title: string; filePath: string }> = {
  scene1: { title: 'Public Exposure', filePath: 'src/components/video/video_scenes/Scene1.tsx' },
  scene2: { title: 'Browser Encryption', filePath: 'src/components/video/video_scenes/Scene2.tsx' },
  scene3: { title: 'Proof on Arc', filePath: 'src/components/video/video_scenes/Scene3.tsx' },
  scene4: { title: 'Private Paperwork, Public Proof', filePath: 'src/components/video/video_scenes/Scene4.tsx' },
};
